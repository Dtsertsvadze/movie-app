    ...
    const getMovies = async () => {
      if (searching) {
        ...
        const searchedMovies = await searchEngine(
          `/search/tv?query=${search}&include_adult=false&language=en-US&page=${pageNumber}`
        );
        ...
        const fetchedMovies = await fetchMovies(
          `/discover/tv?include_adult=false&include_video=false&language=en-US&page=${pageNumber}&sort_by=popularity.desc`
        );
